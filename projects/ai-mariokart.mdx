...
tags: ["AI", "Workflow"]
published: true
thumbnail: "https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/thumbnail1.png?raw=true"
...
In this post, I’ll guide you through my journey of setting up a neural network (NN) capable of simulating **Mario Kart** gameplay, frame by frame, based on the previous frame and a steering input (left or right).

This was achieved **without embedding traditional game logic into the code**. Let's dive into the inspiration, technical challenges, and final implementation of this ambitious project.

<div className="text-ebony-clay-50 flex flex-wrap gap-1 w-full">
  <Shield
    icon="twemoji:hugging-face"
    href="https://huggingface.co/DereWah/diamond-mariokart64"
    text="Model"
  ></Shield>
  <Shield
    icon="twemoji:hugging-face"
    href="https://huggingface.co/datasets/DereWah/mk64-steering"
    text="Dataset"
  ></Shield>
  <Shield
    icon="mdi:github"
    href="https://github.com/Dere-Wah/AI-MarioKart64"
    text="Codebase"
  ></Shield>
  <Shield
    icon="mdi:discord"
    href="https://discord.gg/uMF94QreGc"
    text="Discord"
  ></Shield>
</div>
...
<div className="flex flex-wrap justify-center gap-1">
  <SafeVideo
    src="https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/escaping.mp4?raw=true"
  ...
  />
  <SafeVideo
    src="https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/turn.mp4?raw=true"
    className="w-2/5 justify-center aspect-square"
    autoPlay
    loop
    muted
...
![The original model trained on CSGO.](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/csgo.gif?raw=true)
...
- **Insufficient Data**: Initial tests with just a few minutes of gameplay led to poor results.  
   _(Check out the preliminary output: [**`YouTube link`**](https://youtu.be/2GYaArkV3Ig))._

![The first version of AISM64.](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/sm64ai.gif?raw=true)
...
2. **Image Data** (`_x`):  
   ...
   - `3`: RGB color channels.  
     _(Note: Height and width often swap during tensor conversion—an issue you’ll need to debug when preprocessing.)_
...
![The dataset collection script (this is from when it was collecting SM64, so just 11 inputs instead of 20)](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/vectors_dataset.png?raw=true)
...
![How a dataset looks like from the outside](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/dataset_hdf5.png?raw=true)
...
<div className="flex flex-wrap justify-center gap-1">
  <SafeVideo
    src="https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/flicker.mp4?raw=true"
    className="w-2/5 justify-center aspect-square"
    autoPlay
    loop
    muted
  ...
  />
  <SafeVideo
    src="https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/wallhit.mp4?raw=true"
    className="w-2/5 justify-center aspect-square"
    autoPlay
    loop
    muted
...
![Processing the tar files](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/processing_tar_files.png?raw=true)
...
![Adjusting to fill the GPU on colab](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/filling_gpu.png?raw=true)
...
![Outputs](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/checkpoints.png?raw=true)
...
![Adjusting to fill the GPU on colab](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/ai-mariokart/spawn.png?raw=true)
