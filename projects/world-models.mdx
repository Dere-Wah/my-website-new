...
<SafeVideo
  src="/assets/blog/world-models/water.mp4"
...
paper.](/assets/blog/world-models/bidi-horse.png)
...
![Imagination on the diamond
paper.](/assets/blog/world-models/imagination.gif)
...
<SafeVideo
  src="/assets/blog/world-models/odyssey.mp4"
  className="justify-center"
  autoPlay
  loop
  muted
...
<SafeVideo
  src="/assets/blog/world-models/sfe.mp4"
  className="justify-center"
  autoPlay
  loop
  muted
...
<SafeVideo
  src="/assets/blog/world-models/pov.mp4"
  className="justify-center"
  autoPlay
  loop
  muted
...
<div className="flex flex-row justify-center gap-2">
  <div className="w-full md:w-1/2">
    ![Dream screenshot](/assets/blog/world-models/dream1.jpg)
  </div>
  <div className="w-full md:w-1/2">
    ![Dream screenshot](/assets/blog/world-models/dream2.jpg)
  </div>
  <div className="w-full md:w-1/2">
    ![Dream screenshot](/assets/blog/world-models/dream3.jpg)
  </div>
</div>
...
<SafeVideo
  src="/assets/blog/world-models/decart.mov"
  className="justify-center"
  autoPlay
  loop
  muted
...
<SafeVideo
  src="/assets/blog/world-models/genie3.mp4"
  className="justify-center"
  autoPlay
  loop
  muted
...
<SafeVideo
  src="/assets/blog/world-models/tesla.mp4"
  className="justify-center"
  autoPlay
  loop
  muted
...
<div className="flex flex-wrap justify-center">
  <SafeVideo
    src="/assets/blog/world-models/dream-runway-1.mp4"
  ...
  />
  <SafeVideo
    src="/assets/blog/world-models/dream-runway-2.mp4"
    className="justify-center md:w-1/2"
    autoPlay
    loop
    muted
  ...
  />
  <SafeVideo
    src="/assets/blog/world-models/dream-runway-3.mp4"
  ...
  />
  <SafeVideo
    src="/assets/blog/world-models/dream-runway-4.mp4"
    className="justify-center md:w-1/3"
    autoPlay
    loop
    muted
  ...
  />
  <SafeVideo
    src="/assets/blog/world-models/dream-runway-5.mp4"
    className="justify-center md:w-1/3"
    autoPlay
    loop
    muted
