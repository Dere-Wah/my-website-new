...
tags: ["AI", "Game Dev"]
published: true
thumbnail: "/assets/blog/twister/image.png"
---
...
One thing worth noting is that I had just finished developing my first-ever web-based game, called <Shield icon="twemoji:detective" href="https://spyfall.derewah.dev" text="SpyFall" />. It was a social deduction game with a React front-end and a backend server for networking. Having just taught myself React, I was still fresh with excitement from that project (you can read more about it in another blog post <Shield icon="mdi:alpha-d-circle-outline" url="./spyfall ">HERE</ Shield>).
