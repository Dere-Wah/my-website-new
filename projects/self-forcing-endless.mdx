...
<Callout emoji="💡">
  This scheme only briefly covers the architecture of Self-Forcing. As the
  BlogPost goes in deeper in the details of the changes I applied, each specific
  step will be explained and covered more precisely.
</Callout>
...
<Callout emoji="💡">
  The video accumulates errors over time, and these stack up and become more
...
<div className="flex flex-col md:flex-row justify-center items-center gap-0.5">
  ...
  <div>
    ![Pure nightmare
    fuel](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/self-forcing-endless/4.png?raw=true)
  </div>
  <div>
    ![Pure nightmare
    fuel](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/self-forcing-endless/5.png?raw=true)
  </div>
</div>

<Callout emoji="💡">
  My results, after getting the model to infinitely generate. Pure nightmare
  fuel.
</Callout>
...
<div className="flex flex-row justify-center">
  <div className="md:w-1/2">
    ![The VAE Encoding method, with
    memory](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/self-forcing-endless/vae.png?raw=true)
  </div>
</div>
...
<Callout emoji="💡">
  Here are some of the best results from the cache purge trick. As you can see,
  it is both possible to change what is happening in the scene smoothly, (1) and
  also recover from degradation. (2)
</Callout>
...
After a _lot_ of experimentation, I finally figured out the most effective ways to use the cache purge feature.
...
<Callout emoji="💡">
  For example, if the current scene shows a **cat**, and you suddenly switch the
  prompt to describe a **woman**, the step timing of the purge determines how
  fast and clearly the model adapts. The earlier in the denoising process you
  clear the cache, the more **reactive** the change, because there is more
  **random** noise not influenced by previous cache.
</Callout>
...
The parts marked with (\*) are features that weren’t originally implemented in the Self-Forcing repo, and I had to implement them myself.
...
<Shield
  icon="mdi:reddit"
  href="https://www.reddit.com/r/StableDiffusion/comments/1mrtnr6/making_selfforcing_endless_restoring_from/"
  text="Reddit Post"
/>

<Shield
  icon="fa6-brands:square-x-twitter"
  href="https://x.com/DereWah/status/1956060417244967261"
  text="X Post"
/>

<Shield
  icon="mdi:linkedin"
  href="https://www.linkedin.com/posts/davide-locatelli-91a360304_what-if-ai-video-generation-never-had-to-activity-7361835692005437440-Xy5t"
  text="LinkedIn Post"
/>
