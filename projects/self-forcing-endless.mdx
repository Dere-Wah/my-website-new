...
video_thumbnail: "/assets/blog/self-forcing-endless/demo.mp4"
---
...
- Uses a memory system (a VAE cache) to better convert these latents into human-viewable images and vice versa
...
To fix it, I added a new parameter that let me **control exactly when the cache reset would occur** within the denoising cycle. This gave me precise control over how the model transitioned between states: whether to do a hard cut, a smooth evolution, or a subtle cleanup. I decided to call this parameter **"Reactivity"**.
