...
<Callout emoji="🐱">
Special thanks to my cat for agreeing to be squeezed into a latent for this demo.
</Callout>
...
- **Purging at Step 3**: Too late. The frame is already fully denoised with the old cache, so the next step starts from a "defined" latent: almost no visible change.
