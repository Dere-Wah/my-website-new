...
date: "2025-11-23"
description: "We were really close to being caught."
tags: ["Reverse Engineering", "Exploit", "Security", "Free Food"]
published: false
thumbnail: "https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/thumbnail.png?raw=true"
---
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The
    game](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/game-look.jpg?raw=true)
  </div>
</div>
...
So I called my friend Giovanni.  
...
The next morning, Giovanni sent me a screenshot while I was walking to the gym.
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The login landing
    page](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/login.jpg?raw=true)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The endpoint
    failing](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/route.jpg?raw=true)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ...
    log-in](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/code-snippet.jpg?raw=true)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The endpoint
    failing](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/saving.jpg?raw=true)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The logged in
    game](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/menu.png?raw=true)
  </div>
</div>
...
![The logged in game](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/payload.jpg?raw=true)
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The leaderboard
    website.](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/popup.jpg?raw=true)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The leaderboard
    website.](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/leaderboard.jpeg?raw=true)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ...
    webhook.](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/tracking.jpg?raw=true)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-1/2">
    ![The error
    message.](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/over.png?raw=true)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The
    email.](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/notification.png?raw=true)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-1/2">
    ![The
    tradition.](https://github.com/Dere-Wah/my-website-new/blob/main/private/assets/blog/food-heist/finale.jpg?raw=true)
  </div>
</div>
...
<Shield icon="mdi:github" href="https://github.com/emanuele-toma" text="Toma" />

<Shield icon="mdi:github" href="https://github.com/JustOptimize" text="Mirko" />

<Shield icon="mdi:github" href="https://github.com/gigantino" text="Giovanni" />
