...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The game](/private/assets/blog/food-heist/game-look.jpg)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The login landing page](/private/assets/blog/food-heist/login.jpg)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The endpoint failing](/private/assets/blog/food-heist/route.jpg)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ...
    log-in](/private/assets/blog/food-heist/code-snippet.jpg)
  </div>
</div>

<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The endpoint failing](/private/assets/blog/food-heist/saving.jpg)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The logged in game](/private/assets/blog/food-heist/menu.png)
  </div>
</div>
...
![The logged in game](/private/assets/blog/food-heist/payload.jpg)
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The leaderboard website.](/private/assets/blog/food-heist/popup.jpg)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The leaderboard
    website.](/private/assets/blog/food-heist/leaderboard.jpeg)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ...
    webhook.](/private/assets/blog/food-heist/tracking.jpg)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-1/2">
    ![The error message.](/private/assets/blog/food-heist/over.png)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-3/4">
    ![The email.](/private/assets/blog/food-heist/notification.png)
  </div>
</div>
...
<div className="flex flex-row justify-center">
  <div className="md:w-1/2">
    ![The tradition.](/private/assets/blog/food-heist/finale.jpg)
  </div>
</div>
