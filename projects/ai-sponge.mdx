...
<Callout emoji="💡">
  An episode was essentially a short scene, max 1 minute long, where characters
  discussed a topic in a humorous or completely unhinged way.
</Callout>
...
<Callout emoji="💡">
  When it was time to add new characters, we made polls to let the community
  decide
</Callout>
...
This was a passion project that brought me into contact with many amazing people, including my close friend <Shield icon="mdi:dev-to" href="https://ggtn.ch/" text="Giovanni" />, who was working on a similar idea at the time.
