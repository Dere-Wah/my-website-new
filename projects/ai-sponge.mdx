---
title: "How I Built an AI-Generated Show"
date: "2025-05-17"
...
tags: ["AI", "Livestreaming", "Unity", "GPT-4", "Text-to-Speech", "Procedural Generation"]
thumbnail: "/assets/blog/ai-sponge/thumbnail.png"
published: true 
---
...
<Callout emoji="💡">An episode was essentially a short scene, max 1 minute long, where characters discussed a topic in a humorous or completely unhinged way.</Callout>
...
![A screenshot of the live chat from when my project was running](/assets/blog/ai-sponge/live_chat.png)

<Callout emoji="💡">A screenshot of the live chat from when my project was running</Callout>
...
![Screenshot from a scene of the simulation](/assets/blog/ai-sponge/live.png)

<Callout emoji="💡">Screenshot from a scene of the simulation</Callout>
...
![A scheme of how all the processing worked.](/assets/blog/ai-sponge/info.png)

<Callout emoji="💡">A scheme of how all the processing worked</Callout>
...
<Callout emoji="💡">Everything here is pretty self-explanatory. The final field, `link`, points to the generated voice file.</Callout>
...
![You can imagine the artifacts from AI trying to read this.](/assets/blog/ai-sponge/what.png)

<Callout emoji="💡">You can imagine the artifacts from AI trying to read this.</Callout>
...
![When it was time to add new characters, we made polls to let the community decide](/assets/blog/ai-sponge/poll.png)

<Callout emoji="💡">When it was time to add new characters, we made polls to let the community decide</Callout>
...
![An old screenshot from when the project was running on twitch.](/assets/blog/ai-sponge/livetwitch2.png)

<Callout emoji="💡">An old screenshot from when the project was running on twitch</Callout>
...
If anyone knows me, they also know I _love_ breaking the 4th wall. Anything that winks to the user, and becomes at any point self-aware, makes me really appreciate the self-irony of the people behind it.
...
![The stream being self aware was hilarious](/assets/blog/ai-sponge/transition.png)
...
![The stream being self aware was hilarious](/assets/blog/ai-sponge/transition2.png)

<Callout emoji="💡">The stream being self aware was hilarious</Callout>
...
![Guide for topics suggestions](/assets/blog/ai-sponge/guide.png)
...
This was a passion project that brought me into contact with many amazing people, including my close friend <Shield icon="mdi:dev-to" href="https://ggtn.ch/" text="Sean" />, who was working on a similar idea at the time.

He even wrote a <Shield icon="mdi:touch-text-outline" href="https://legacy.ggtn.ch/blog/ai-generated-show" text="blog post" /> about his experience with AI-generated shows. If you're curious, check it out!
